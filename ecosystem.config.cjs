  ...
  apps: [
    ...
    },
    {
      ...
      env: {
        ...
        REDIS_PORT: "6379",
        // Only set if actually present in env — otherwise let dotenv .env value pass through.
        // gateway.js does { ...process.env, ...svc.env }, so empty string here would override .env.
